...
if __name__ == "__main__":
    ...
    uncompressed_public_key_hex = raw_to_uncompressed_public_key(public_key_hex)

    if function_name == "encrypt_data":
        encrypted_data = encrypt_data(data, private_key_hex, uncompressed_public_key_hex)
        print(encrypted_data)
    
    if function_name == "decrypt_data":
        decrypted_data = decrypt_data(data, private_key_hex, uncompressed_public_key_hex)
